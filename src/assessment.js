  ...
  return $q(function(resolve, reject){
    setTimeout(function() {
      if (changed != true) {
        ...
        reject("boolean is already true.");
      }
    }, 5000);
  });
}
...
// Make a constructor function called Sandwich that takes in 3 parameters: 
//bread, meat, spread and assigns them to identically named properties.
...
// #7  ###################
// # Implicit binding
// Make a constructor function called RoadTrip.  It has a property called gasLeft = 100.  
// It has a property called drive that is a function.  
// When drive is invoked it uses context to implicitly subract 10 from the gasLeft on the roadTrip.
function RoadTrip() {
  this.gasLeft = 100;
  this.drive = function() {
    this.gasLeft -= 10;
...
// #9  ###################
// # Prototype 2
// Write a constructor function called CoinToss.  It has a property called results which is an empty array.  
//It has a prototype function called flip.  When flip is invoked it uses context to implicitly add 'heads' or 'tails' to the results array.

function CoinToss() {
  this.results = [];
  this.flip = function() {
    var flipResult = Math.floor(Math.random() * ((2 - 1) + 1) + 1);
    if (flipResult === 1) {this.results.push("heads");}
...
// #10  ###################
// # Closure 1
// Write a function called animalMachine that creates new animals from two existing animals.  It takes in a parameter called partOne.  
//It returns a function called animalSmasher.
...
// When addGuest is invoked it saves that guest with previously added guests and then returns an object that looks like this 
